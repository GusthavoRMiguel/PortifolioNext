      ...
      <div className="container mx-auto mt-8 md:mt-0 md:space-x-10 md:grid grid-cols-3 justify-center md:py-40">
          ...
          <div className="mt-8 md:mt-0 lg:justify-end col-span-2">
            ...
            <div className="flex flex-wrap justify-center gap-2 py-4">
             <Link href="https://github.com/GusthavoRMiguel" target="__black"><button  className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
             ...
             <Link href="https://www.linkedin.com/in/gusthavo-rm/" target="__black">
              ...
              <Link href="https://wa.me/5511982735663" target="__black">
